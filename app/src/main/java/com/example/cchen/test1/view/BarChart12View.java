...
public class BarChart12View extends DemoView {
    ...
    public static final double NO_CHANGE = -1;
...
//			chart.addSubtitle("(XCL-Charts Demo)");
            ...
            chart.getBar().setItemLabelStyle(XEnum.ItemLabelStyle.NORMAL);
            chart.getBar().getItemLabelPaint().setColor(Color.rgb(162, 53, 46));
            chart.getBar().getItemLabelPaint().setTextSize(40);
    ...
    private void chartRender2() {
        try {
            ...
            chart2.setPadding(ltrb[0], ltrb[1],
                    ltrb[2], ltrb[3] + getResources().getDimensionPixelSize(R.dimen.bar_chart_padding_bottom));
            ...
            chart2.getBar().setItemLabelStyle(XEnum.ItemLabelStyle.BOTTOM);
            chart2.getBar().getItemLabelPaint().setColor(Color.WHITE);
            chart2.getBar().getItemLabelPaint().setTextSize(60);

//            chart2.getBar().setBarRoundRadius(15);
            chart2.getBar().setBarStyle(XEnum.BarStyle.OUTLINE);
            ...
            //柱形比设大点
            chart2.getBar().setBarTickSpacePercent(0.4f);
//            chart2.getCategoryAxis().setTickLabelRotateAngle(45);
            chart2.getCategoryAxis().getTickLabelPaint().setColor(Color.BLACK);
            chart2.getCategoryAxis().getTickLabelPaint().setTextSize(getResources().getInteger(R.integer.bar_chart_size));
            chart2.getCategoryAxis().setTickLabelMargin(getResources().getInteger(R.integer.tick_label_margin));
            ...
            //柱形和标签居中方式
            chart2.setBarCenterStyle(XEnum.BarCenterStyle.SPACE);
    ...
    public void chartDataSet2(double a, double b, double c) {
        //标签对应的柱形数据集
        List<Double> dataSeriesA = new LinkedList<Double>();
        if (a != NO_CHANGE) dataSeriesA.add(a);
        if (b != NO_CHANGE) dataSeriesA.add(b);
//        dataSeriesA.add(90d);
        if (c != NO_CHANGE) dataSeriesA.add(c);
...
//        dataColorA.add(Color.rgb(66, 115, 156));
        ...
        chartData2.clear();
        chartData2.add(new BarData("", dataSeriesA, dataColorA, Color.rgb(33, 129, 239)));
    }

    private void chartLabels2() {
//        chartLabels2.add("Kerberos");
        chartLabels2.add("变速器油压");
        chartLabels2.add("燃油液位");
        chartLabels2.add("变矩器油温");
    }
