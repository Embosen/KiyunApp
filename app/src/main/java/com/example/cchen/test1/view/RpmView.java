 ...
 *
 */
public class RpmView extends GraphicalView {

    public static final float MAX_VALUE = 5000f;
...
//        rlabels.add("60");
    ...
    private void addAttrInfo() {
        ...
        plotAttrInfo.addAttributeInfo(XEnum.Location.TOP, "转速\nx100", 0.3f, paintTB);
        ...
        plotAttrInfo.addAttributeInfo(XEnum.Location.BOTTOM, "r/min", 0.8f, paintBT2);
    }
